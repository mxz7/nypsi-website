...
<div class="mx-3 mb-10 mt-7 flex flex-col sm:mx-auto sm:w-[50vw]">
  ...
  <div in:fly={{ delay: 600, duration: 500, y: 75 }}>
    {#if userData.Economy.EconomyGuildMember?.guild}
      <div
        class="mt-4 flex w-full flex-col rounded border border-gray-300 border-opacity-5 bg-gray-950 bg-opacity-25 p-4 duration-300 hover:border-accent hover:border-opacity-20 hover:bg-opacity-40"
      >
  ...
  <div in:fly={{ delay: 700, duration: 500, y: 75 }}>
    {#if userData.Economy.Inventory.length > 1}
      <div
        class="mt-4 flex w-full flex-col justify-center rounded border border-gray-300 border-opacity-5 bg-gray-950 bg-opacity-25 p-4 duration-300 hover:border-accent hover:border-opacity-20 hover:bg-opacity-40"
        id="inventory"
      >
          ...
          {#each inPlaceSort(userData.Economy.Inventory).asc((i) => i.item) as item}
            {#if items.find((i) => i.id === item.item)}
              <a
                ...
                class="hover:bg-opacity- mx-2 flex flex-col items-center justify-center rounded border border-gray-500 border-opacity-10 bg-gray-700 bg-opacity-5 py-2 align-middle text-xs text-gray-300 shadow duration-300 hover:border-accent hover:border-opacity-25 lg:text-sm"
              >
          ...
          {#each games as game}
            <a
              ...
              style="color: {game.win == 1
                ...
                ? 'rgb(239, 68, 68)'
                : 'rgb(254, 240, 138)'};"
              class="mt-3 flex w-full flex-col items-center justify-center rounded border border-gray-500 border-opacity-10 bg-gray-700 bg-opacity-5 p-2 px-4 align-middle shadow duration-300 hover:border-accent hover:border-opacity-25 lg:mt-0"
            >
  ...
  <div in:fly={{ delay: 1100, duration: 500, y: 75 }} class="w-full">
    {#if userData.WordleStats}
      <div
        class="mx-auto mt-4 flex w-fit flex-col rounded border border-gray-300 border-opacity-5 bg-gray-950 bg-opacity-25 p-4 duration-300 hover:border-accent hover:border-opacity-20 hover:bg-opacity-40"
        id="wordle"
      >
