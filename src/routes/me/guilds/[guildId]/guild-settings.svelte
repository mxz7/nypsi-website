...
>
  ...
  <Card mode="section" class="flex min-h-0 flex-col gap-4">
    <div class="flex items-center gap-3">
      <span class="rounded-box bg-base-300 text-primary p-2">
  ...
  <Card mode="section" class="flex flex-col gap-4">
    <div class="flex items-center gap-3">
      ...
      <div>
        <h3 class="font-bold">prefixes</h3>
  ...
  <Card mode="section" class="flex flex-col gap-4">
    ...
    {#if modlogsEnabled && !dashboard.settings.modlogsChannelId}
      <div class="alert alert-warning text-sm">
        the existing modlogs webhook could not be matched to a channel; select a channel to replace
        it or choose disabled
      </div>
    {/if}
