const badges = new Map([
  ...
  [
    "staff",
    {
      ...
      name: "nypsi staff",
      description:
        "staff of the official nypsi server or the discord bot. these people help to moderate and answer any questions that users might have",
    },
  ],
  [
    "contributor",
  ...
  [
    "season_winner",
    {
      ...
      name: "season winner",
      description:
        "these people have played nypsi enough to have won an economy season. nypsi's economy is seasonal. meaning that everything resets (except some things) every few months",
    },
  ],
  [
    "og",
